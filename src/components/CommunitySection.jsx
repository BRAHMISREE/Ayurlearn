      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-16">
        ...
        >
          ...
          <p className="text-base text-[#5c5045] dark:text-[#d4c7b4] leading-relaxed">
            Connect with 10,000+ learners, healers, and wellness seekers. Share your journey, discover timeless wisdom, and grow together in a space that values balance and nature.
          </p>
          <a
            href="/register"
